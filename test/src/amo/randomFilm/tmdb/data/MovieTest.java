...
import amo.randomFilm.datasource.tmdb.data.Image;
...
public class MovieTest {
    ...
    // movie = gson.fromJson(iterator.next(), Movie.class);
    // System.out.println("Movie: " + movie);
    //            
    // String json = gson.toJson(movie);
    // System.out.println("Movie as JSON: " + json);
    // }
    //        
    // }
    ...
    public void testMovieImport() {
        ...
        Movie movie1 = gson.fromJson(iterator.next(), Movie.class);
        Movie movie2 = gson.fromJson(iterator.next(), Movie.class);
        Movie movie3 = gson.fromJson(iterator.next(), Movie.class);
        ...
        List<Image> posters = movie2.getPosters();
